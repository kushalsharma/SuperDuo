...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        Log.e(save_tag, "will save");
        Log.e(save_tag, "fragment: " + String.valueOf(my_main.mPagerHandler.getCurrentItem()));
        Log.e(save_tag, "selected id: " + selected_match_id);
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        Log.e(save_tag, "selected id: " + savedInstanceState.getInt("Selected_match"));
